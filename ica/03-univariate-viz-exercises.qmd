...
3 different parts which include:"moderate, difficult, easy"
b.  What about a visualization of the *quantitative* `elevation` variable?
We just want the number to be correct  install.packages("tidyverse")
...
ggplot(world_cup,aes(x = winner))+geom_bar()
```
